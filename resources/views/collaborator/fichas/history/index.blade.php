...
<div class="container">
	<div class="row mb-5">
		...
		<div class="col-lg-4 col-md-4 col-sm-6 col-12">
			<a href="{{ route('collaborator.peticiones.index') }}" class="btn btn-outline-secondary btn-block">Volver</a>
		</div>	
	</div>
	            ...
	            @foreach ($fichas_history as $ficha_pending)
				    <tr>
				      ...
				      <td>
			      	  ...
			      	  <td>{{ route('collaborator.historial.show', $ficha_pending->id) }}</td>
				    </tr>
			    @endforeach
	           </tbody>
	       </table>
...
@push('scripts')
	@include('shared_partials.fichas.moderation.datatable', ['table_id' => 'history-table', 'column' => 5])
@endpush
