...
<div id="ficha-form">
	...
	<form v-on:submit.prevent="onSubmit('store-form')" id="store-form" action="{{ route('admin.fichas.store') }}" method="post" enctype="multipart/form-data">
		@csrf
		...
		<div class="container">
			<div class="row mb-4">
				...
				<div class="col-lg-2 col-md-2 col-12">
					<a href="{{ route('admin.fichas.index') }}" class="btn btn-outline-danger btn-block">Cancelar</a>
				</div>	
			</div>
		</div>
