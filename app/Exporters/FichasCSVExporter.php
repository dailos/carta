...
class FichasCSVExporter
{
    ...
    private function getHeader() : array
    {
        return  ['Código', 'X', 'Y', 'Zona UTM', 'X Pico Nieves', 'Y Poco Nieves', 'Latitud', 'Longitud',
            ...
            'Observaciones Generales', 'Fotos', 'Croquis', 'Enlaces', 'Multimedia', 'Contactos', 'Creada', 'Actualizada'
        ];
    }
    ...
    private function getFichaContent(Ficha $ficha) : array
    {
        ...
        return [
            ...
            $ficha->multimedia ? json_encode($ficha->multimedia): "",
            $ficha->contactos? json_encode($ficha->contactos): "",
            $ficha->created_at,
            $ficha->updated_at,
        ];
    }
